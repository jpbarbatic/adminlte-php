          ...
          <form action="login.php" method="post">
            <div class="input-group mb-1">
              <div class="form-floating">
                <input name="login_email" id="loginEmail" type="email" class="form-control" value="" placeholder="" required />
            ...
            <div class="input-group mb-1">
              <div class="form-floating">
                <input name="login_password" id="loginPassword" type="password" class="form-control" placeholder="" required />
